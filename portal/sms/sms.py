...
def send_sms(message_text, phone_number):
    ...
    api_string = "http://bhashsms.com/api/sendmsg.php?user=9404792579&pass=8ac45b9&sender=MDHOBI&phone="+str(phone_number).strip()+"&text="+text+"&priority=ndnd&stype=normal"
    try:
